/*
  ...
  1. New Tables
    - `infrastructure_nodes` - Stores information about infrastructure nodes
    - `monitoring_metrics` - Stores time-series metrics data
    - `monitoring_alerts` - Stores alert definitions
    - `alert_instances` - Stores individual alert occurrences
    - `alert_notifications` - Stores notification records for alerts
    - `system_events` - Stores system-wide events
    - `performance_baselines` - Stores performance baseline data
