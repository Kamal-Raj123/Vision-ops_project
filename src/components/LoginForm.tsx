    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">VisionOps</h1>
          <p className="text-blue-200">DevSecOps Platform</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            ...
            <div className="text-xs text-blue-700 space-y-1">
              <p><strong>Admin:</strong> techey.kamal@gmail.com / password</p>
              <p><strong>DevOps:</strong> karthick@example.com / password</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-8">
          <p className="text-blue-200 text-sm">
            © 2024 VisionOps. All rights reserved.
          </p>
        </div>
      </div>
    </div>
